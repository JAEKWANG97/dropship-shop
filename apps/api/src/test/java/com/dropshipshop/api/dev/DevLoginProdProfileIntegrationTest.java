...
@SpringBootTest(
	...
	"app.supplier-portal.hmac-secret=test-prod-supplier-portal-hmac-secret-1234567890",
	"app.supplier-portal.kakao-redirect-uri=http://localhost/api/supplier/auth/kakao/callback",
	"app.supplier-portal.success-redirect-uri=http://localhost:3000/supplier",
	"app.inquiry.lookup-secret=test-inquiry-lookup-secret-at-least-32-characters",
	"APP_BANK_TRANSFER_BANK_NAME=테스트은행",
	"APP_BANK_TRANSFER_ACCOUNT_NUMBER=000-000-000000",
	"APP_BANK_TRANSFER_ACCOUNT_HOLDER=테스트예금주",
