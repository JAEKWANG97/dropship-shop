  ...
  return (
    <section className="narrow-page account-page">
      <header className="account-heading">
        ...
        <h1>내 계정</h1>
        <p>회원정보와 배송지를 관리하고 주문 내역을 확인하세요.</p>
      </header>
      <nav className="account-nav" aria-label="내 계정 메뉴">
        <a href="#profile">회원정보</a>
        <a href="#addresses">배송지</a>
      ...
      <section className="account-form" id="addresses">
        <h2>배송지 관리</h2>
        <p className="field-help">주문할 때 사용할 배송지를 저장해 두세요.</p>
        {addresses.error ? (
          <div className="notice danger">
      ...
      <div className="account-footer-actions">
        <Link href="/products">상품 계속 보기</Link>
