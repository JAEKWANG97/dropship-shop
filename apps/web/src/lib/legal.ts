    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "소셜 로그인 후 주문, 배송, 클레임 처리를 위해 이름, 연락 가능한 이메일, 휴대폰 번호 등 필수 정보를 입력해야 할 수 있습니다.",
        ],
      },
      {
        heading: "주문과 결제",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "결제와 분쟁 대응을 위해 주문 상품, 결제 금액, 결제 수단, 입금자명, 입금 확인 시각, 환불 및 클레임 처리 이력을 보관합니다.",
        ],
      },
      {
        heading: "보유 기간",
      ...
      },
      {
        ...
        paragraphs: [
          "주문 상품의 발주와 배송을 위해 수령인 이름, 이메일, 전화번호, 우편번호와 배송지를 해당 상품의 도매꾹 공급처 및 공급처가 이용하는 택배사에 제공합니다.",
          "제공 목적은 상품 발주, 배송, 취소와 배송 문의 처리이며, 공급처 주문과 배송 목적을 달성한 뒤에는 관련 법령상 보존 의무가 없는 정보를 지체 없이 파기합니다.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "계좌입금 주문은 실제 환불 이체 후 관리자가 완료를 기록한 때에만 환불 완료로 표시합니다.",
        ],
      },
    ],
  },
