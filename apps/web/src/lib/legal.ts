...
export const BUSINESS_PROFILE = {
  ...
  mailOrderSalesRegistrationNumber: "준비중",
  mailOrderSalesRegistrationAuthority: "준비중",
  businessAddress: "서울특별시 송파구 동남로11길 4, 103동 1405호",
  returnAddress: "서울특별시 송파구 동남로11길 4, 103동 1405호",
  customerCenterPhone: "사이트 문의 접수",
  customerCenterEmail: "사이트 문의 접수",
  customerCenterHours: "사이트 문의 접수 기준으로 확인",
  privacyOfficerName: "김문교",
  privacyOfficerEmail: "사이트 문의 접수",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "결제와 분쟁 대응을 위해 주문 상품, 결제 금액, 결제 수단, PG 거래 식별자, 환불 및 클레임 처리 이력을 보관합니다.",
        ],
      },
      {
        heading: "보유 기간",
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "환불 기준",
        paragraphs: [
          "반품이 필요한 환불은 반품 상품 입고와 관리자 검수 후 PG 취소/환불을 요청합니다.",
