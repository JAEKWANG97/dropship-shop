...
- B-100~B-103이 배포된 동안에도 production supplier portal feature gate는 닫아 portal 상품을 고객에게 구매 가능하게 만들지 않는다. B-102 inventory guard와 B-103 fulfillment/privacy 기반은 필요조건일 뿐이며 B-104~B-105와 privacy/live-email/contract gate가 모두 준비된 뒤에만 activation gate를 연다.
