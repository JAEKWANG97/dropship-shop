...
- B-092 기존 후보 포함 카테고리별 최대 60개 확장 수집
  ...
  - 보호: 동음이의어·비산업용 노이즈 33개와 상한 초과 18개를 활성 후보에서 분리했다. 전체 자동 리뷰는 `IMPORT 756 / EXCLUDE 57 / 중복 0`이지만 이번 작업에서는 운영 import·공개를 실행하지 않았다. 미분류 안전장갑 55개는 판매 카테고리 확정 전까지 제외한다.
