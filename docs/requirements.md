...
- 주문서에는 주문 상품, 결제 금액, 배송지, 배송/취소/환불 정책, 결제 후 품절 가능성, 품절 시 전액 환불 안내를 확인하는 통합 체크박스가 있어야 한다.
- 주문서 통합 확인 체크박스를 선택하지 않으면 결제 요청을 진행할 수 없어야 한다.
- 주문 시점에 고객이 확인한 정책 버전과 확인 시각을 저장해야 한다.
...
- 상품 상세와 주문서 모두에서 결제 후 공급처 품절 가능성과 품절 시 전액 환불 정책을 고지해야 한다.
